...
// async defines part of the callback function as the await needs to be inside an async function
// expression to work. Finally define that the mysql2 connection object (db) is able to use the 
// promise query method
// The data is held inside the local variable tvshow as an array object with two items.
